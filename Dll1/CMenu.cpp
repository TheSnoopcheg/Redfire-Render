...
CMenu::CMenu(IDirect3DDevice9* device_ptr) {
    ...
    io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\arialbd.ttf", 15.0f, &font_config, io.Fonts->GetGlyphRangesCyrillic());
    this->Theme();
...
void CMenu::Render() {
    ...
    if (renderWindow) {
        ...
        ImGui::Checkbox("3d text", &textRenderStatus);
